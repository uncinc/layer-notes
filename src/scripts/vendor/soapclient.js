 ...
 * Licensed under GPLv2: https://github.com/gtathub/js-soap-client.git
 ...
 There are small improvements done by Mat1th.
\*****************************************************************************/

let SOAPClientParameters = function () {
  var _pl = new Array();
  var _sl = new Array();
...
// private: wsdl cache
let SOAPClient_cacheWsdl = new Array();

// private: invoke async
SOAPClient._loadWsdl = function (url, method, parameters, async, callback) {
  // load from cache?
  var wsdl = SOAPClient_cacheWsdl[url];
  if (wsdl != null && typeof wsdl != "undefined" && wsdl != "" && wsdl != "undefined")
  ...
  if (SOAPClient.userName && SOAPClient.password) {
    ...
    // console.log(SOAPClient._toBase64(SOAPClient.userName + ":" + SOAPClient.password));
